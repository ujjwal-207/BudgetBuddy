...
exports.calculateMoneyHealthScore = calculateMoneyHealthScore;
exports.getMoneyHealthGrade = getMoneyHealthGrade;
function calculateQualityScore(expense) {
...
function calculateMoneyHealthScore(expenses, budgets, income) {
    let score = 0;
...
function getMoneyHealthGrade(score) {
    if (score >= 80) {
