...
function getLastOccurrenceOfDay(dayName: string): Date {
...
function getDateFromOrdinal(dayStr: string): Date {
  const today = new Date();
...
export function parseNaturalLanguage(input: string): ParsedExpense {
...
export function getCategoryFromKeywords(text: string): string {
